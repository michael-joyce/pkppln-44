...
class StatementTest extends AbstractSwordTestCase {
	...
	public function testStatementMismatch() {
		...
		$this->assertEquals(400, $this->client->getResponse()->getStatusCode());
		$this->assertContains('Deposit does not belong to journal.', $this->client->getResponse()->getContent());
	}
	...
	public function testStatementJournalNonFound() {
		...
		$this->assertContains('object not found', $this->client->getResponse()->getContent());
	}
